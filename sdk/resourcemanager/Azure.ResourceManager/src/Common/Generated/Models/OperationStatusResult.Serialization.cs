    ...
    public partial class OperationStatusResult : IUtf8JsonSerializable, IJsonModel<OperationStatusResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(Error))
            {
                ...
                ModelSerializationExtensions.JsonSerialize(writer, Error, options: null);
            }
        }
        ...
        internal static OperationStatusResult DeserializeOperationStatusResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("operations"u8))
                {
                    ...
                    {
                        array.Add(ModelSerializationExtensions.JsonDeserialize<OperationStatusResult>(item.GetRawText(), options: null));
                    }
                    operations = array;
                    continue;
                }
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = ModelSerializationExtensions.JsonDeserialize<ResponseError>(property.Value.GetRawText(), options: null);
                    continue;
                }
            }
